...
//     calculerSurface() {
//         var surface = Math.PI * this.rayon * this.rayon;
//         return surface;
//     }
//     afficherInfo() {
...
class CompteBancaire{
    ...
    calculerPlus(montant) {
        // var plus = this.solde + montant;
        // this.solde = plus;
   this.solde=this.solde+montant
}
    calculerMoin(montant) {
       this.solde=this.solde-montant
    }
...
let ab = new CompteBancaire("Abraham", 5);
