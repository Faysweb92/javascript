...
var mois = prompt("saisir un numéro de mois:")
mois = mois.toLowerCase(); 
//accepte les majuscules//

switch (mois) {
    case "janvier":
        document.write("le nombre de jour de janvier est de 31 jours:");
        
        break;
    
    case "février":
        document.write("le nombre de jour de janvier est de 30 jours:");
